...
git clone --depth=1 git@github.com:iamcco/markdown-preview.nvim.git ~/.vim/pack/plugins/start/markdown-preview && cd ~/.vim/pack/md/start/markdown-preview && yarn install > /dev/null && cd ~
#Navigation
